      ...
      <Container className={style.container}>
        ...
        <div className={style.footerContainer}>
          ...
          <div className={style.social}>
            ...
            <div className={style.socialSubtitle}>
              <a href="#!" className={style.link}>Контакты и адреса магазинов</a>
            </div>
